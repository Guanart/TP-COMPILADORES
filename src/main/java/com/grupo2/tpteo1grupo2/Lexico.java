        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { 
                ...
                resultados += "Caracter no permitido: " + yytext() + "> en la linea " + yyline + "\n";
            }
            // fall through
          case 36: break;
          case 2: 
          ...
          case 39: break;
          case 5: 
            { System.out.println("Token SIMBOLO encontrado, Lexema "+yytext());
          ...
          case 50: break;
          case 16: 
            { System.out.println("Token TRUE encontrado, Lexema "+yytext());
          ...
          case 52: break;
          case 18: 
            { System.out.println("Token RANGE encontrado, Lexema "+yytext());
              resultados += "Token RANGE encontrado, Lexema "+yytext() + "\n";
            } 
            // fall through
          case 53: break;
          case 19: 
            { System.out.println("Token FALSE encontrado, Lexema "+yytext());
          ...
          case 60: break;
          case 26: 
            { System.out.println("Token ENDFOR encontrado, Lexema "+yytext());
          ...
          case 62: break;
          case 28: 
            { System.out.println("Token FOREACH encontrado, Lexema "+yytext());
              resultados += "Token FOREACH encontrado, Lexema "+yytext() + "\n";
            } 
            // fall through
          case 63: break;
          case 29: 
            { System.out.println("Token BOOLEAN encontrado, Lexema "+yytext());
              resultados += "Token BOOLEAN encontrado, Lexema "+yytext() + "\n";
            } 
            // fall through
          case 64: break;
          case 30: 
            { System.out.println("Token ENDWHILE encontrado, Lexema "+yytext());
