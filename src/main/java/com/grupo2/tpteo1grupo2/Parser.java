...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Jun 11 19:11:11 ART 2025
  */
...
public ArrayList<NodoDeclaracion> combinarIdTipo() {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
    ...
    //parser.actualizarTipo(ac.toString() + id.toString() + da.toString() + type.toString() + cc.toString());
		...
		int esright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Object es = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		RESULT = listaDeclaraciones; reglas += "Regla 02: DECLARE_SEC --> " + ds + " DECLARACIONES " + es + "\n";
		...
		ArrayList<NodoSentencia> ps = (ArrayList<NodoSentencia>)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new NodoPrograma(null,ps);
                                        parser.actualizarTipo(listaDeclaraciones);
