...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Apr 29 11:36:23 ART 2025
  */
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		NodoExpresion cons = (NodoExpresion)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		
    RESULT = operacionOplist(oc, cons);
    reglas += "Regla 54: OPLIST_CONST --> " + oc + pyc + cons + "\n";
		...
		Object om = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = om;
                    operadorOplist = om.toString();
                    reglas += "Regla 53: OPLIST_OPERACION --> " + om + "\n"; 
		...
		Object os = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		   RESULT = os;
                                    operadorOplist = os.toString();
                                    reglas += "Regla 52: OPLIST_OPERACION --> " + os + "\n";
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("oplist_operacion",26, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
